    ...
    implements Serializable
{
    ...
    public Server( Integer id, Date startDate, String name, String containerID, Long memorySize, String containerIP,
                   String dockerState, Status status, Image image, Map<String, String> listPorts, List<String> links )
    {
        super();
        this.id = id;
    ...
    {
        return "Server [id=" + id + ", startDate=" + startDate + ", name=" + name + ", containerID=" + containerID
