...
import fr.treeptik.cloudunit.maven.plugin.model.Application;
import fr.treeptik.cloudunit.maven.plugin.model.Image;
import fr.treeptik.cloudunit.maven.plugin.model.Module;
import fr.treeptik.cloudunit.maven.plugin.model.Server;
import fr.treeptik.cloudunit.maven.plugin.model.User;
